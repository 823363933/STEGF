...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.stegf_version = "unversioned"
        self.sh_degree = 3
        self._source_path = ""
        self._model_path = ""
        self._images = "images"
        ...
        self.field_bg_dense_source_time_select = 0
        ...
        self.field_h2_velocity_reg_weight = 0.0001
        ...
        self.field_mvstruct_conflict_specialize = 0
        self.field_mvstruct_conflict_directional_split = 0
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.field_existence_lr = 0.005
        self.field_interval_center_lr = 0.0001
        self.field_interval_width_lr = 0.003
        self.field_h2_lr = 0.001
